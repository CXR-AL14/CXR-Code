...
class YOLO(object):
    _defaults = {
        ...
        # --------------------------------------------------------------------------#
        "model_path": 'logs/ep014-loss5.026-val_loss4.296.pth',
        # "model_path": '/Chen/yolox/logs/ep002-loss4.550-val_loss4.234.pth',
        # "model_path": '/Chen/yolox/logs/ep001-loss4.408-val_loss4.272.pth',
